...
class MainWindow(QtGui.QMainWindow,Ui_MainWindow):
	def __init__(self,app):
		...
		self.connect(self.btnExec,SIGNAL('clicked()'),self.onBtnImportInvoiceExecClick)
...
#		self.invoices={}
	...
	def onBtnImportInvoiceExecClick(self):
...
#		print self.libfile
		...
		self.cbxInvoiceTypes.addItem(u'所有')
		self.cbxInvoiceTypes.addItem(u'专票')
		self.cbxInvoiceTypes.addItem(u'普票')

		self.cbxInvoiceStatus.addItem(u'所有')
		self.cbxInvoiceStatus.addItem(u'正常')
		self.cbxInvoiceStatus.addItem(u'已作废')
